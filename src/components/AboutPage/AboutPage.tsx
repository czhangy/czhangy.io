            ...
            <section className={styles["about-section"]}>
                ...
                <div className={styles["section-content"]}>
                    <p className={styles["section-text"]}>
                        ...
                        raised in the LA area of California and am currently a
                        senior studying computer science at UCLA. I was
                        practically raised on video games and the countless
                        ...
                        are fun facts about me to fill space: I played one year
                        of JV tennis in high school, I am the self-proclaimed
                        least competent Eagle Scout in the world, my greatest
                        fear is heights, I don&apos;t know how to ride a bike, I
                        think I&apos;m a very funny person, my girlfriend does
                        not.
                    </p>
            ...
            >
                ...
                <div className={styles["section-content"]}>
                    ...
                    <p className={styles["section-text"]}>
                        ...
                        {/* This upcoming winter (assuming
                        I don&apos;t get laid off), I&apos;ll be joining Amazon
                        in San Diego as a Software Development Engineer.  */}{" "}
                        If for some reason you want more details on my work,
                        check out the projects and experience pages!
                    </p>
                </div>
            </section>
            <section className={styles["about-section"]}>
                ...
                <div className={styles["section-content"]}>
                    <p className={styles["section-text"]}>
                        ...
                        heart for the Pokémon, Diablo, and Call of Duty
                        franchises, but I&apos;ve spent plenty of hours across
                        all sorts of games. When it&apos;s basketball season, I
                        also spend hours feeding my obsession for the NBA, and
                        am a huge Warriors fan (not a bandwagon, I swear) and
                        analytics nerd. When I do actually go out and touch
                        grass, I mostly enjoy hanging out with friends and
                        working out on the rare days when I&apos;m not injured.
                    </p>
                    <div className={styles["section-img"]}>
                        <Image
